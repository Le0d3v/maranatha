  ...
  return (
    <>
      <div className="bg-mauve-950 h-screen md:flex">
        ...
        <div className="relative w-full md:w-1/2 overflow-hidden bg-[#090708] flex items-center justify-center px-8 py-12">
          <BackgroundAnimado />
          ...
          <div className="relative z-10 w-full max-w-md">
            <Link to="/">
              <img
                ...
                alt="Logo"
                className="w-86 mx-auto mb-8"
              />
            </Link>

            <p className="text-center text-gray-400 mb-10 leading-relaxed text-sm">
